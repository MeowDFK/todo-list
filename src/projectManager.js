...
export default class ProjectManager{
    ...
    static addingProject(value){
        ...
        project.className="active:bg-purple-500 p-2 w-full  hover:border-white hover:border-solid hover:bg-violet-500 hover:text-white flex flex-row justify-between rounded-md border-violet-200 text-sm leading-6 text-violet-200 font-medium py-3 bg-gray-800";
